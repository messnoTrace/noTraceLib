...
public class DealUnKnowException implements UncaughtExceptionHandler {
	...
	// 保存的路径
	private String resPath = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "log" + File.separator;
	...
	public void collectDeviceInfo(Context ctx) {
		...
		for (Field field : fields) {
			...
			//	LogUtils.d(field.getName() + "," + field.get(null).toString());
			} catch (Exception e) {
				e.printStackTrace();
			}
		}
